...
// React Bits BorderGlow — an edge-proximity mesh-gradient border + outer glow that lights up as
// the pointer nears the card edge. Ported verbatim; we drive it with green + our surface color.
